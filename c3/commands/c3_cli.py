...
@click.option('--report',
              help='Render the results including customized notes of users.')
@click.option('--silent',
              help='The silent mode is useful for automation.')

def main(c3username, c3apikey, verbose, level, report, silent):
    pass
